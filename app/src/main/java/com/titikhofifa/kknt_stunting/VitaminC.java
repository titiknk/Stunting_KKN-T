...
public class VitaminC extends AppCompatActivity {
    ...
    private void Fitur1() {
        Intent intent = new Intent(this, Paprika.class);
        startActivity(intent);
    }

    private void Fitur2() {
        Intent intent = new Intent(this, BuahKiwi.class);
        startActivity(intent);
    }
    ...
    private void Fitur4() {
        Intent intent = new Intent(this, Pepaya.class);
        startActivity(intent);
    }

    private void Fitur5() {
        Intent intent = new Intent(this, Stroberi.class);
        startActivity(intent);
    }
    ...
    private void Fitur7() {
        Intent intent = new Intent(this, Tomat.class);
        startActivity(intent);
    }

    private void Fitur8() {
        Intent intent = new Intent(this, JambuMerah.class);
        startActivity(intent);
    }

    private void Fitur9() {
        Intent intent = new Intent(this, CabaiMerah.class);
        startActivity(intent);
    }
