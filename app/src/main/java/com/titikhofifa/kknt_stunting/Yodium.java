...
public class Yodium extends AppCompatActivity {
    ActionBar actionBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yodium);
        getSupportActionBar().setTitle("Yodium");
    ...
    private void Fitur1() {
        Intent intent = new Intent(this, IkanTuna.class);
        startActivity(intent);
    }

    private void Fitur2() {
        Intent intent = new Intent(this, Udang.class);
        startActivity(intent);
    }

    private void Fitur3() {
        Intent intent = new Intent(this, RumputLaut.class);
        startActivity(intent);
    }

    private void Fitur4() {
        Intent intent = new Intent(this, GaramBeryodium.class);
        startActivity(intent);
    }
    ...
    private void Fitur8() {
        Intent intent = new Intent(this, BuahPrune.class);
        startActivity(intent);
    }

    private void Fitur9() {
        Intent intent = new Intent(this, KacangLima.class);
        startActivity(intent);
    }
