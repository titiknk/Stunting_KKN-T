...
public class Seng extends AppCompatActivity {
    ActionBar actionBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_seng);
        getSupportActionBar().setTitle("Seng");
    ...
    private void Fitur3() {
        Intent intent = new Intent(this, Daging.class);
        startActivity(intent);
    }
    ...
    private void Fitur6() {
        Intent intent = new Intent(this, BijiBijian.class);
        startActivity(intent);
    }
    ...
    private void Fitur8() {
        Intent intent = new Intent(this, JenisSayurKentang.class);
        startActivity(intent);
    }
