...
public class ZatBesi extends AppCompatActivity {
    ActionBar actionBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_zat_besi);
        getSupportActionBar().setTitle("Zat Besi");
    ...
    private void Fitur4() {
        Intent intent = new Intent(this, Kerang.class);
        startActivity(intent);
    }
    ...
    private void Fitur9() {
        Intent intent = new Intent(this, Quinoa.class);
        startActivity(intent);
    }
