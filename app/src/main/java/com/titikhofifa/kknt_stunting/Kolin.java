...
public class Kolin extends AppCompatActivity {
    ActionBar actionBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kolin);
        getSupportActionBar().setTitle("Kolin");
    ...
    private void Fitur2() {
        Intent intent = new Intent(this, KuningTelur.class);
        startActivity(intent);
    }
    ...
    private void Fitur5() {
        Intent intent = new Intent(this, Ikan.class);
        startActivity(intent);
    }
    ...
    private void Fitur8() {
        Intent intent = new Intent(this, KembangKol.class);
        startActivity(intent);
    }

    private void Fitur9() {
        Intent intent = new Intent(this, KacangHijau.class);
        startActivity(intent);
    }
