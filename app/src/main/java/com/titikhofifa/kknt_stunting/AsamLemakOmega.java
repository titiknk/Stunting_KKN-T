...
public class AsamLemakOmega extends AppCompatActivity {
    ActionBar actionBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_asam_lemak_omega);
        getSupportActionBar().setTitle("Asam Lemak Omega 3 dan Omega 6");
    ...
    private void Fitur1() {
        Intent intent = new Intent(this, Makarel.class);
    ...
    private void Fitur4() {
        Intent intent = new Intent(this, Tiram.class);
        startActivity(intent);
    }

    private void Fitur5() {
        Intent intent = new Intent(this, BijiChia.class);
        startActivity(intent);
    }

    private void Fitur6() {
        Intent intent = new Intent(this, Mede.class);
        startActivity(intent);
    }

    private void Fitur7() {
        Intent intent = new Intent(this, KacangKenari.class);
        startActivity(intent);
    }
