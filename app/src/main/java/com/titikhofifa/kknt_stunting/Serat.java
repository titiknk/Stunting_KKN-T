...
public class Serat extends AppCompatActivity {
    ActionBar actionBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_serat);
        getSupportActionBar().setTitle("Serat");
    ...
    private void Fitur2() {
        Intent intent = new Intent(this, Apel.class);
        startActivity(intent);
    }

    private void Fitur3() {
        Intent intent = new Intent(this, Pir.class);
        startActivity(intent);
    }

    private void Fitur4() {
        Intent intent = new Intent(this, KacangAlmond.class);
        startActivity(intent);
    }

    private void Fitur5() {
        Intent intent = new Intent(this, Pisang.class);
        startActivity(intent);
    }

    private void Fitur6() {
        Intent intent = new Intent(this, Wortel.class);
        startActivity(intent);
    }

    private void Fitur7() {
        Intent intent = new Intent(this, UbiJalar.class);
        startActivity(intent);
    }

    private void Fitur8() {
        Intent intent = new Intent(this,Oat.class);
        startActivity(intent);
    }

    private void Fitur9() {
        Intent intent = new Intent(this, KacangPolong.class);
        startActivity(intent);
    }
